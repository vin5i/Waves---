...
interface CardanoLogoProps {
	logoColor: string;
}

export default function CardanoLogo({ logoColor }: CardanoLogoProps) {
	/** Image attributes */
	const [background, setBackground] = useState('bg-[#0e0e0e]');
	...
	return (
		<div
			...
			className={clsx(
				background,
				'h-[300px] w-[300px] transition-all duration-500 overflow-hidden',
				'rounded-full',
		...
		>
			<svg version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 375 346.5">
				<g id="Layer_2_1_">
					<g id="Layer_1-2">
						<path
							fill={logoColor}
